<script lang="ts">
	import BackToTableOfContents from './BackToTableOfContents.svelte';
</script>

<svelte:head>
	<title>Terms of Service - jami.et</title>
</svelte:head>

<div class="container mx-auto px-4 py-8">
	<h1 class="mb-4 text-3xl font-bold">TERMS OF SERVICE</h1>

	<p class="mb-4">Last updated October 19, 2024</p>

	<section class="mb-8">
		<h2 class="mb-3 mt-6 text-2xl font-semibold">AGREEMENT TO OUR LEGAL TERMS</h2>
		<p class="mb-4">
			We are Jami | jami.et ("Company," "we," "us," "our"), a company registered in Ethiopia.
		</p>
		<p class="mb-4">
			We operate the website jami.et (the "Site"), as well as any other related products and
		...
		<p class="mb-4">
			...
			or on behalf of an entity ("you"), and Jami | jami.et, concerning your access to and use
			of the Services. You agree that by accessing the Services, you have read, understood, and
			agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL
		...
		<p class="mb-4">
			...
			The modified Legal Terms will become effective upon posting or notifying you by terms@jami.et,
			as stated in the email message. By continuing to use the Services after the effective date of
	...
	<h2 class="mb-3 mt-6 text-2xl font-semibold" id="table-of-contents">TABLE OF CONTENTS</h2>

	<ol class="list-inside list-decimal space-y-2">
		<li><a href="#our-services" class="hover:underline">OUR SERVICES</a></li>
		<li>
			<a href="#intellectual-property-rights" class="hover:underline"
				>INTELLECTUAL PROPERTY RIGHTS</a
			>
		</li>
		<li><a href="#user-representations" class="hover:underline">USER REPRESENTATIONS</a></li>
		<li><a href="#user-registration" class="hover:underline">USER REGISTRATION</a></li>
		<li><a href="#purchases-and-payment" class="hover:underline">PURCHASES AND PAYMENT</a></li>
		<li><a href="#subscriptions" class="hover:underline">SUBSCRIPTIONS</a></li>
		<li><a href="#prohibited-activities" class="hover:underline">PROHIBITED ACTIVITIES</a></li>
		<li>
			<a href="#user-generated-contributions" class="hover:underline"
				>USER GENERATED CONTRIBUTIONS</a
			>
		</li>
		<li><a href="#contribution-license" class="hover:underline">CONTRIBUTION LICENSE</a></li>
		<li><a href="#guidelines-for-reviews" class="hover:underline">GUIDELINES FOR REVIEWS</a></li>
		<li><a href="#social-media" class="hover:underline">SOCIAL MEDIA</a></li>
		<li>
			<a href="#third-party-websites-and-content" class="hover:underline"
				>THIRD-PARTY WEBSITES AND CONTENT</a
			>
		</li>
		<li><a href="#advertisers" class="hover:underline">ADVERTISERS</a></li>
		<li><a href="#services-management" class="hover:underline">SERVICES MANAGEMENT</a></li>
		<li><a href="#privacy-policy" class="hover:underline">PRIVACY POLICY</a></li>
		<li><a href="#copyright-infringements" class="hover:underline">COPYRIGHT INFRINGEMENTS</a></li>
		<li><a href="#term-and-termination" class="hover:underline">TERM AND TERMINATION</a></li>
		<li>
			<a href="#modifications-and-interruptions" class="hover:underline"
				>MODIFICATIONS AND INTERRUPTIONS</a
			>
		</li>
		<li><a href="#governing-law" class="hover:underline">GOVERNING LAW</a></li>
		<li><a href="#dispute-resolution" class="hover:underline">DISPUTE RESOLUTION</a></li>
		<li><a href="#corrections" class="hover:underline">CORRECTIONS</a></li>
		<li><a href="#disclaimer" class="hover:underline">DISCLAIMER</a></li>
		<li>
			<a href="#limitations-of-liability" class="hover:underline">LIMITATIONS OF LIABILITY</a>
		</li>
		<li><a href="#indemnification" class="hover:underline">INDEMNIFICATION</a></li>
		<li><a href="#user-data" class="hover:underline">USER DATA</a></li>
		<li>
			<a href="#electronic-communications" class="hover:underline"
				>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a
			>
		</li>
		<li>
			<a href="#california-users-and-residents" class="hover:underline"
				>CALIFORNIA USERS AND RESIDENTS</a
			>
		</li>
		<li><a href="#miscellaneous" class="hover:underline">MISCELLANEOUS</a></li>
		<li><a href="#contact-us" class="hover:underline">CONTACT US</a></li>
	</ol>

	<section id="our-services">
		<h2 class="mb-3 mt-6 flex items-center justify-start gap-2 text-2xl font-semibold group">
			1. OUR SERVICES
	...
	<section id="intellectual-property-rights">
		...
		<h3 class="mb-2 mt-4 text-xl font-semibold">Our intellectual property</h3>
		<p class="mb-4">
		...
		<h3 class="mb-2 mt-4 text-xl font-semibold">Your use of our Services</h3>
		<p class="mb-4">
		...
		<p class="mb-4">solely for your personal, non-commercial use or internal business purpose.</p>
		<p class="mb-4">
		...
		<p class="mb-4">
			...
			section or elsewhere in our Legal Terms, please address your request to: support@jami.et. If
		...
		<h3 class="mb-2 mt-4 text-xl font-semibold">Your submissions and contributions</h3>
		<p class="mb-4">
		...
		<p class="mb-4">
			...
			and logos): By posting any Contributions, you grant us an unrestricted, unlimited,
			irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide
			right, and license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast,
			retitle, store, publicly perform, publicly display, reformat, translate, excerpt (in whole or
			in part), and exploit your Contributions (including, without limitation, your image, name, and
			voice) for any purpose, commercial, advertising, or otherwise, to prepare derivative works of,
			or incorporate into other works, your Contributions, and to sublicense the licenses granted in
		...
		<p class="mb-4">
			...
			these Legal Terms. If we remove or edit any such Contributions, we may also suspend or disable
			your account and report you to the authorities.
		</p>

		<h3 class="mb-2 mt-4 text-xl font-semibold">Copyright infringement</h3>
		<p class="mb-4">
	...
	<section id="user-representations">
		...
		<p class="mb-4">By using the Services, you represent and warrant that:</p>
		<ol class="mb-4 ml-4 list-inside list-decimal">
			<li>
	...
	<section id="purchases-and-payment">
		...
		<p class="mb-4">
			...
			applicable shipping fees, and you authorize us to charge your chosen payment provider for any
    ...
    <h2 class="mb-3 mt-6 flex items-center justify-start gap-2 text-2xl font-semibold group">
		...
		<p class="mb-4">Billing and Renewal</p>
		<p class="mb-4">
		...
		<p class="mb-4">Free Trial</p>
		<p class="mb-4">
			We offer a 14-day free trial to new users who register with the Services. The account will not
			be charged and the subscription will be suspended until upgraded to a paid version at the end
			of the free trial.
		</p>

		<p class="mb-4">Cancellation</p>
		<p class="mb-4">
			All purchases are non-refundable. You can cancel your subscription at any time by logging into
			your account. Your cancellation will take effect at the end of the current paid term. If you
			have any questions or are unsatisfied with our Services, please email us at support@jami.et.
		</p>

		<p class="mb-4">Fee Changes</p>
		<p class="mb-4">
	...
	<section id="contribution-license">
		...
		<p class="mb-4">
			...
			and includes our use of your name, company name, and franchise name, as applicable, and any of
	...
	<section id="guidelines-for-reviews">
		<h2 class="mb-3 mt-6 flex items-center justify-start gap-2 text-2xl font-semibold group">
		...
		<p class="mb-4">
			...
			paid, assignable, and sublicensable right and license to reproduce, modify, translate,
	...
	<section id="social-media">
		...
		<p class="mb-4">
			...
			account on the Services. Please note that if a Third-Party Account or associated service
			...
			Services. You will have the ability to disable the connection between your account on the
			Services and your Third-Party Accounts at any time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH
			THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY
			BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review any
			Social Network Content for any purpose, including but not limited to, for accuracy, legality,
			or non-infringement, and we are not responsible for any Social Network Content. You
			...
			purposes of identifying and informing you of those contacts who have also registered to use
			...
			(if applicable). We will attempt to delete any information stored on our servers that was
	...
	<section id="third-party-websites-and-content">
		...
		<p class="mb-4">
			...
			by us. If you decide to leave the Services and access the Third-Party Websites or to use or
			...
			products or services offered on Third-Party Websites and you shall hold us blameless from any
	...
	<section id="privacy-policy">
		...
		<p class="mb-4">
			...
			<a href="https://jami.et/PP">https://jami.et/PP</a>. By using the Services, you agree to be
			bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised
			the Services are hosted in Germany and United States. If you access the Services from any other
			region of the world with laws or other requirements governing personal data collection, use,
			or disclosure that differ from applicable laws in Germany and United States, then through
			your continued use of the Services, you are transferring your data to Germany and United
			States, and you expressly consent to have your data transferred to and processed in Germany
			and United States.
			transferring your data to Germany and United States, and you expressly consent to have your
			data transferred to and processed in Germany and United States.
		</p>
	</section>
	...
	<section id="term-and-termination">
		...
		<p class="mb-4">
			...
			IN THE SERVICES OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY
    ...
    <h2 class="mb-3 mt-6 flex items-center justify-start gap-2 text-2xl font-semibold group">
		...
		<p class="mb-4">
			These Legal Terms shall be governed by and defined following the laws of Ethiopia. jami |
			jami.et and yourself irrevocably consent that the courts of Ethiopia shall have exclusive
	...
	<section id="dispute-resolution">
		...
		<p class="mb-4">Informal Negotiations</p>
		<p class="mb-4">
		...
		<p class="mb-4">Binding Arbitration</p>
		<p class="mb-4">
			...
			shall be two (2). The seat, or legal place, or arbitration shall be Addis Ababa, Ethiopia. The
			language of the proceedings shall be English. The governing law of these Legal Terms shall be
			substantive law of Ethiopia.
		</p>

		<p class="mb-4">Restrictions</p>
		<p class="mb-4">
		...
		<p class="mb-4">Exceptions to Informal Negotiations and Arbitration</p>
		<p class="mb-4">
	...
	<section id="limitations-of-liability">
		...
		<p class="mb-4">
			...
			THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING
			...
			ARISING OR $60.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS
	...
	<section id="contact-us">
		...
		<p class="mb-1">jami | jami.et</p>
		<p class="mb-1">Addis Ababa</p>
		<p class="mb-1">Ethiopia</p>
		<p class="mb-1">Phone: +251986563511</p>
		<p class="mb-1">support@jami.et</p>
	</section>
</div>
